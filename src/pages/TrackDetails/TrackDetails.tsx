...
//  // Fonction pour envoyer l’instrument au backend
//   const handleAddInstrumentSubmit = async (instrument: { nom: string }) => {
...
//         null,
//         { params: { instrumentId: instrument.nom } }
//       );
...
//   <AddInstrumentForm
//     ensembleId={currentEnsembleId}        // ou documentId si ton DTO le demande
//     onSubmit={handleAddInstrumentSubmit}  // la fonction pour envoyer l'instrument
//     onClose={handleCloseAddInstrument}    // pour fermer le modal
//   />
// )}
...
//             {files.map((file) => (
//               <div key={file.id} className="file-with-instrument">
//                 {/* <FileItemComponent file={file} onDelete={handleDelete} />
//                 <button
//                   className="add-instrument-button"
//                   onClick={() => {
//                     console.log(
//                       "Ajouter un instrument pour le document",
//                       file.id
//                     );
//                   }}
//                 >
...
//                 {/* <button
//   className="add-instrument-button"
//   onClick={() => handleOpenAddInstrument(file.id)}
// >
//   Ajouter un instrument
// </button> */}
// <FileItemComponent file={file} onDelete={handleDelete} />
