...
const MemberItem: React.FC<{ member: Member, isAdmin: boolean }> = ({ member, isAdmin }) => {
    ...
    const handleRoleChange = () => {
        ...
        alert(`Changer le rôle de ${member.name} en ${member.role === 'admin' ? 'membre' : 'administrateur'} ?`);
    };
        ...
        <div className="member-item">
            ...
            <div className="member-actions">
                ...
                {isAdmin && !isCurrentUser && (
                    <>
                        <button onClick={handleRoleChange} className="action-button role-button" title="Changer le rôle">
                            {member.role === 'admin' ? 'Rétrograder' : 'Promouvoir'}
                        </button>
                        <button onClick={handleRemoveMember} className="action-button remove-button" title="Retirer de l'ensemble">
                            Retirer
                        </button>
                    </>
                )}
