  ...
  return (
    <div className="invitation-container">
      ...
      <div className="container">
          ...
          <div className="card-grid">
            {invitations.map((inv) => (
              <div className="invitation-card" key={inv.id}>
                {/* Nom */}
                <h3>{inv.utilisateurNom || "-"}</h3>
                {/* Photo optionnelle */}
        {inv.photoUrl && (
          <img
            src={inv.photoUrl}
            alt={inv.utilisateurNom}
        ...
        {inv.instrument && (
          <p>
            <strong>Instrument :</strong> {inv.instrument}
          </p>
        )}

                <p>
                  <strong>Email :</strong> {inv.emailInvite}
                </p>
                <p>
                  <strong>Statut :</strong> {inv.etat || "En attente"}
                </p>
                <p>
                  <strong>Rôle :</strong>{" "}
                  <input
