...
export const AddScore = () => {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const morceauIdentifier = isNewMorceau
      ...
      : `Morceau ID: ${existingMorceauId} (${
          mockMorceaux.find((t) => t.id === Number(existingMorceauId))?.title ||
          "Inconnu"
        })`;
      ...
      <main className="auth-main">
        ...
        <div className="form-card">
          <form onSubmit={handleSubmit}>
            ...
            <label htmlFor="morceau-link" className="form-label">
              Lier à un morceau
            </label>
            <select
              id="morceau-link"
            ...
            <button
              ...
              disabled={
                isUploading ||
                !file ||
                (isNewMorceau && !newMorceauTitle.trim())
              }
            >
              <FaUpload />{" "}
