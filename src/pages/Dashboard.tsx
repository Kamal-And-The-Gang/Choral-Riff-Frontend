...
const mockEnsembles: Ensemble[] = [
  {
    ...
    profilePic: "../assets/ensemble-pic-1.jpg",
  },
  {
    id: 2,
    name: "Le Chœur Allegro",
    profilePic: "../assets/ensemble-pic-2.jpg",
  },
  {
    id: 3,
    name: "Orchestre Lyrique",
    profilePic: "../assets/ensemble-pic-3.jpg",
  },
];
...
const EnsembleVignette: React.FC<{ ensemble: Ensemble }> = ({ ensemble }) => {
  ...
  return (
    <a
      href={ensembleLink}
      className="ensemble-vignette"
      title={`Ouvrir l'ensemble ${ensemble.name}`}
    >
      <div className="vignette-image-container">
        ...
        <img
          ...
          className="ensemble-vignette-pic"
        />
      </div>
