...
export const mockNotifications: NotificationDTO[] = [
    {
        id: 1,
        type: 'INVITATION',
        message: 'Vous êtes invité à rejoindre l\'ensemble "Harmonie Chorale" par Sophie L.',
        isRead: false, // 💡 Non lu
    ...
    },
    {
        id: 3,
        type: 'MORCEAU_AJOUTE',
        message: 'Le morceau "Ode à la Joie" a été ajouté à l\'ensemble Harmonie Chorale.',
        isRead: false, // 💡 Non lu
